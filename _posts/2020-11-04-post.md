...
<center><img src="/image/20-11-04/fork.png" width="60%" height="60%"></center>

이제 사진에 fork를 누르자. fork를 누르면 TeXt테마가 저장되있는 리포지토리를 자신의 계정으로 복사하여 가져온다.

<center><img src="/image/20-11-04/setting.png" width="60%" height="60%"></center>
...
<center><img src="/image/20-11-04/publish_ready.png" width="60%" height="60%"></center>

이런 페이지를 볼 수 있다. 좀 기다리다 새로고침을 누르면 

<center><img src="/image/20-11-04/publish.png" width="60%" height="60%"></center>

이렇게 변하는데 사이트가 퍼블리싱이 됐다고 뜬다. 빨간 네모칸을 눌러서 들어가보자.

사이트가 나오면 블로그를 만들 준비가 된 것이다. 지금 나온 사이트가 앞으로 만들어갈 블로그이다. 

<center><img src="/image/20-11-04/blog_main.png" width="60%" height="60%"></center>
