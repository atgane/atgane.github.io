...
toc: true
toc_sticky: true
excerpt: "select문에 우선순위를 주입하는 방법과, 고루틴·채널·select·atomic을 조합하여 이벤트루프를 구현하는 방법을 알아봅니다."
author_profile: true
header:
...
- Close 시 `closeCh`를 닫아 `closeCh`의 recv가 가능하도록 합니다.
...
[전체 코드](https://github.com/atgane/syncgo/blob/d81c5d9266c1ded5f7ea2f05040ac373893906b6/01/ds/eventloop.go)
