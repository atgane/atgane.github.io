...
$$A = \begin{pmatrix} \dfrac {\partial T} {\partial T'} & \dfrac {\partial T} {\partial x'} \\ \dfrac {\partial x} {\partial T'} & \dfrac {\partial x} {\partial x'} \end{pmatrix}$$

$$
\dfrac {\partial} {\partial T} = \dfrac {\partial T'} {\partial T}\dfrac {\partial } {\partial T'} + \dfrac {\partial x'} {\partial T}\dfrac {\partial T} {\partial x'}
$$

$$
\dfrac {\partial} {\partial x} = \dfrac {\partial T'} {\partial x}\dfrac {\partial } {\partial T'} + \dfrac {\partial x'} {\partial x}\dfrac {\partial T} {\partial x'}
$$
